        ...
        <div class="col-xs-12">
            ...
            <form method="post" action="{{ action('Account\AccountController@update') }}" class="form-horizontal">
                ...
                <div class="form-group {{ $errors->has('first_name') ? 'has-error' : ''}}">
                    <label for="first_name" class="control-label col-sm-2">Voornaam *</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group {{ $errors->has('name_prefix') ? 'has-error' : ''}}">
                    <label for="name_prefix" class="control-label col-sm-2">Tussenvoegsel</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group {{ $errors->has('last_name') ? 'has-error' : ''}}">
                    <label for="last_name" class="control-label col-sm-2">Achternaam *</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group {{ $errors->has('phone_number') ? 'has-error' : ''}}">
                    <label for="phone_number" class="control-label col-sm-2">Telefoonnummer *</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group {{ $errors->has('address') ? 'has-error' : ''}}">
                    <label for="address" class="control-label col-sm-2">Adres *</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group {{ $errors->has('zip_code') ? 'has-error' : ''}}">
                    <label for="zip_code" class="control-label col-sm-2">Postcode *</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group {{ $errors->has('city') ? 'has-error' : ''}}">
                    <label for="city" class="control-label col-sm-2">Stad *</label>
                    <div class="col-sm-6">
